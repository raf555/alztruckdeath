...
typedef char StrWahana[100]; 
extern BinTree TreeWahana;


extern StrWahana NamaWahana[7];
extern int HargaWahana[7];
extern int KapasitasWahana[7];
extern int DurasiWahana[7];
extern StrWahana DeskripsiWahana[7];
extern int UangBangunan[7];
extern StrWahana BahanBangunan[7];
...
void ADVW();
void BuildTreeFromFile(BinTree *P);
